...
// not the legacy generated nrc-XX assets. Equal stages preserve the complete frame.
export const NrcSpriteImage: React.FC<NrcSpriteImageProps> = ({
  ...
  const image = <img src={photo.thumbnailSrc} alt={alt} loading={priority ? 'eager' : 'lazy'} className="block w-full h-full object-contain" />;
